...
<html lang="es">
    ...
    ?>
        ...
        <div class="container">
            ...
            <fieldset >
                <legend><center>Añadir Mensaje</center></legend>
                <form id="mensaje" action="admin/modificarmensaje.php" method="POST">
                        ...
                        <input type="submit" id="registro" name="registro" value="Guardar" class="btn btn-group-justified">
